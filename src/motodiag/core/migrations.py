    ...
    Migration(
        ...
        upgrade_sql="""
            ...
            ((SELECT id FROM workflow_templates WHERE slug='tire_service_v1'), 1,
             ...
             'The worn tire is evidence about the machine, so read it before it is gone. Cited: the KTM 250/300 EXC TPI owner''s manual — "Low tire pressure leads to abnormal wear and overheating of the tire" (PDF p. 116); the Honda CB500F owner''s manual — "Inspect the tires for signs of abnormal wear on the contact surface" (PDF p. 60). No maker''s document in the research library names wear patterns such as cupping, feathering or squaring, so none is named here: the makers describe abnormal wear and name its causes.',
             'Measure the tread depth at the centre and at both shoulders of each tire, and look for the tread wear indicators: the BMW F800R rider''s manual reads a tyre as worn out when the tread reaches the marks, located by the letters TI or TWI or by an arrow on the tyre edge (PDF p. 100). The minimum depth is the machine''s own figure: the Honda CB500F owner''s manual sets 1.5 mm front and 2.0 mm rear (PDF p. 134), the Honda PCX service manual the same, measured at the centre of the tread (PDF p. 97), and the KTM 250/300 EXC owner''s manual at least 2 mm (PDF p. 115). Then run a hand and an eye around the whole contact surface and across its profile, and note wear that is not even — across the tread, around the circumference, or different from one side to the other — and where on the tire it sits. Record the pressure the tire came in at before letting it down.',
             'Even wear across the profile and around the tire, tread above the machine''s minimum, indicators not reached, pressure at the machine''s figure.',
             'Tread at or below the machine''s minimum or at the indicators, wear that is uneven across or around the tire, a tire that came in under pressure.',
             'A new tire does not cure what wore the old one. Start with the makers'' own first cause: the KTM manual ties abnormal wear and overheating to low pressure (PDF p. 116), so the pressure the tire came in at is the first question. Then look past the tire at the wheel: the same manual warns that spokes with too little tension form lateral and radial run-out in the wheel (PDF p. 116), and the fitting item checks rim runout while the wheel is off. What the pattern says about suspension or alignment is the machine''s service manual''s to answer, not a named pattern''s.',
             1, '["tread depth gauge","tire pressure gauge"]', 10),
            ...
            ((SELECT id FROM workflow_templates WHERE slug='tire_service_v1'), 3,
             ...
             'An old tire with good tread still ages: the makers'' lines apply regardless of wear (KTM EXC manual, PDF p. 116; Honda CB500F manual, PDF p. 62). Record the codes on the job so the next service starts from them.',
             1, '[]', 3),
            ...
            ((SELECT id FROM workflow_templates WHERE slug='tire_service_v1'), 4,
             ...
             'Before breaking the bead, find the adhesive label on the rim that marks the sensor''s position, and tell whoever mounts the tire that the wheel carries one: the F800R manual warns that incorrect tyre-removal procedures can damage the sensors (PDF p. 103). Break the bead away from the sensor and keep the mounting tools clear of it. After fitting, the display shows nothing until the machine has been ridden above approximately 30 km/h for the first time (R 1200 GS manual, PDF p. 100). The displayed pressure is corrected to a 20 °C tyre temperature (F800R manual, PDF p. 76), so a warm tire reads differently on a gauge: the R 1200 GS manual has you compare the reading with the table value and correct the difference with the air line (PDF p. 101).',
             ...
             'No reading can be a damaged sensor from the tire change, a wheel without sensors, or radio interference nearby (the F800R manual lists all three, PDF p. 38); a battery warning is the sensor''s own battery running down (PDF p. 39) and is a sensor replacement, not a tire fault.',
             0, '["tire pressure gauge"]', 5),

            ((SELECT id FROM workflow_templates WHERE slug='tire_service_v1'), 5,
             'Fitting the replacement tire',
             'Cited: the KTM 250/300 EXC owner''s manual — "Only mount tires approved and/or recommended by KTM" (PDF p. 115); the Honda CB500F owner''s manual — the recommended tires or equivalents "of the same size, construction, speed rating, and load range" (PDF p. 61), and never a tube inside a tubeless tire (PDF p. 62); the BMW F 800 GS rider''s manual — "Note direction-of-rotation arrows on tyre or rim" (PDF p. 178); the Honda PCX service manual — rim runout service limits 2.0 mm axial and 2.0 mm radial (PDF p. 326).',
             'Check the new tire against the machine''s own manual: the KTM manual allows only tires KTM approves or recommends (PDF p. 115), and the Honda CB500F manual the recommended tires or equivalents of the same size, construction, speed rating and load range (PDF p. 61). Never fit a tube inside a tubeless tire on a tubeless rim — the CB500F manual warns the tube can burst from heat build-up (PDF p. 62). Mount the tire with its direction-of-rotation arrow running the way the wheel turns, and refit the wheel the right way round: the BMW F 800 GS manual names a wheel installed the wrong way round as an accident risk (PDF p. 178). While the wheel is off, spin the rim on a stand against a dial indicator: actual runout is half the total indicator reading, and the Honda PCX service manual''s limits are 2.0 mm axial and 2.0 mm radial (PDF p. 326), as are the Kymco People S 250''s (service manual PDF p. 188) — for other machines, their own manual''s figure.',
             ...
             'A rim over its runout limit is a wheel problem a new tire will not hide: on a laced wheel, true it or check the spokes (the KTM manual''s run-out warning, PDF p. 116); on a cast wheel, the machine''s manual decides repair or replacement.',
            ...
            ((SELECT id FROM workflow_templates WHERE slug='tire_service_v1'), 7,
             ...
             'Set the cold pressure to the machine''s own figure — its manual or the label on the machine, for example 2.5 bar front and 2.9 bar rear on the BMW S 1000 XR (rider''s manual PDF p. 206) — and check the bead line sits evenly round both sides of the rim. Tell the rider how to run the new tires in: the F800R manual has the smooth new surface roughened by riding in a restrained manner at various lean angles (PDF p. 67), and the R 1200 GS manual warns that new tyres do not give full grip straight away, especially on wet roads (PDF p. 85).',
            ...
            ((SELECT id FROM workflow_templates WHERE slug='brake_service_v1'), 1,
             ...
             'Figures are the named machine''s own. Cited: KTM 250/300 EXC owner''s manual — lining minimum thickness at least 1 mm (PDF p. 102), linings always changed in pairs, and while pushing the pistons back "Ensure that brake fluid does not flow out of the brake fluid reservoir" (PDF p. 104); BMW F800R rider''s manual — pad wear limit min 1.0 mm, "Friction pad only, without backing plate. The wear indicators (grooves) must be clearly visible" (PDF p. 94); Yamaha Zuma 125 2009 service manual — pad wear limit 0.8 mm (PDF p. 134); Piaggio Beverly 125 service manual — pad minimum 1.5 mm (PDF p. 196).',
             'Measure the friction material on every pad, not the backing plate, against the machine''s own limit: KTM EXC at least 1 mm (PDF p. 102), BMW F800R 1.0 mm with the grooves still clearly visible (PDF p. 94), Yamaha Zuma 125 0.8 mm (PDF p. 134), Piaggio Beverly 125 1.5 mm (PDF p. 196). Replace pads as a set — the KTM manual changes linings in pairs (PDF p. 104) and the Honda CB500F owner''s manual replaces left and right pads at the same time (PDF p. 77). Before pressing the pistons back to make room, open or watch the reservoir: the KTM manual has you extract fluid if necessary so it cannot overflow (PDF p. 104). Check that the pads slide freely on their pins and that the pins and springs are sound.',
             'Friction material above the machine''s limit on every pad, or new pads fitted as a set; pistons pushed back without overflowing the reservoir.',
            ...
            ((SELECT id FROM workflow_templates WHERE slug='brake_service_v1'), 2,
             ...
             'Figures are the named machine''s own. Cited: KTM 250/300 EXC owner''s manual — disc wear limits for the standard models front 2.5 mm, rear 3.5 mm (PDF p. 100); Honda PCX service manual — disc thickness service limit 3.0 mm, warpage service limit 0.30 mm (PDF p. 371); Yamaha Zuma 125 2009 service manual — thickness minimum 3.5 mm, deflection maximum 0.15 mm (PDF p. 119); Kymco People S 250 service manual — thickness 4.0 mm standard, 3.0 mm limit, runout 0.30 mm (PDF p. 184).',
             'Measure the disc thickness with a micrometer at several points round the swept area, and check the runout with a dial indicator with the wheel on its axle. Compare with the machine''s own limits: the KTM EXC standard models'' discs wear to 2.5 mm front and 3.5 mm rear (PDF p. 100); the Honda PCX disc to 3.0 mm, with 0.30 mm warpage (PDF p. 371); the Yamaha Zuma 125 disc to 3.5 mm, with 0.15 mm deflection (PDF p. 119); the Kymco People S 250 disc from 4.0 mm new to 3.0 mm, with 0.30 mm runout (PDF p. 184). Inspect the friction surface for deep scoring, cracks and heat discolouration.',
             'Thickness above the machine''s limit at every point, runout inside its limit, no cracks or deep scoring.',
             'Thickness at or under the limit anywhere, runout over the limit, cracks, deep scoring.',
             'A disc at its thickness limit is replaced, not skimmed below it. Runout over the limit shows as a pulsing lever; check the wheel bearings and the disc''s seat on the hub before condemning the disc.',
            ...
            ((SELECT id FROM workflow_templates WHERE slug='brake_service_v1'), 3,
             ...
             'When a caliper leaks, a piston sticks or the seals are due. Cited: Yamaha Zuma 125 2009 service manual — "Whenever a brake caliper is disassembled, replace the piston seal and dust seal" (PDF p. 146), its component schedule: piston seal every two years, brake hose every four (PDF p. 146), "Never use solvents on internal brake components", and piston seals lubricated with brake fluid, dust seals with silicone grease (PDF p. 147); Honda PCX service manual — caliper cylinder I.D. service limits 25.460 mm and 22.710 mm, piston O.D. 25.31 mm and 22.56 mm (PDF p. 384).',
             'Drain the system and remove the pistons (the Zuma 125 service manual drains the whole system first and blows the pistons out with compressed air at the hose joint, PDF p. 145), then the piston seals and dust seals. Clean the bores and grooves with brake fluid only — the Zuma manual forbids solvents on internal brake components because they make the piston seal swell and distort (PDF p. 147). Inspect the pistons and bores for scoring and corrosion, and measure them against the machine''s own limits: the Honda PCX''s cylinder I.D. limits are 25.460 mm and 22.710 mm and its piston O.D. limits 25.31 mm and 22.56 mm (PDF p. 384); the Kymco People S 250''s piston O.D. limit is 25.30 mm (service manual PDF p. 194). Fit new piston seals and dust seals every time — the Zuma manual''s rule (PDF p. 146) and the Piaggio Beverly''s, which replaces all seals every time the caliper is serviced (PDF p. 193) — lubricating the piston seals with brake fluid and the dust seals with silicone grease (Zuma, PDF p. 147).',
             ...
             'Scored or corroded pistons or bores, a dimension past its limit, old seals refitted, solvent used inside the caliper.',
             'A bore or piston past its limit is replaced, not honed. The Zuma manual''s schedule is the maker''s own answer to "when": piston seals every two years, the hose every four, the fluid every two years and whenever the brake is disassembled (PDF p. 146).',
             0, '["brake fluid","silicone grease","micrometer","bore gauge"]', 40),

            ((SELECT id FROM workflow_templates WHERE slug='brake_service_v1'), 4,
             'Master cylinder',
             'When the lever sinks, the master cylinder leaks, or the seals are due. Cited: Honda PCX service manual — master cylinder I.D. service limit 12.755 mm, master piston O.D. 12.645 mm (PDF p. 373), and "Keep the piston, cups, spring, snap ring and boot as a set; do not substitute individual parts" (PDF p. 374); Piaggio Beverly 125 service manual — all seals and gaskets replaced every time the pump is serviced (PDF p. 201).',
             'Drain the system, remove the master cylinder, and take out the boot, snap ring, piston, cups and spring. Clean with brake fluid, inspect the bore for scratches and corrosion, and measure against the machine''s own limits — the Honda PCX''s cylinder I.D. 12.755 mm and piston O.D. 12.645 mm (PDF p. 373); the Kymco People S 250''s cylinder I.D. 12.75 mm (service manual PDF p. 191). Rebuild with the piston, cups, spring, snap ring and boot as a set, never mixed parts (PCX, PDF p. 374), and every seal new (Beverly, PDF p. 201).',
             'Bore clean and inside its limit; a complete new piston set fitted.',
            ...
            ((SELECT id FROM workflow_templates WHERE slug='brake_service_v1'), 5,
             ...
             'Cited: KTM 250/300 EXC owner''s manual — "Never use DOT 5 brake fluid. It is silicone-based", and "Brake fluid attacks paint" (PDF p. 102); DOT 4 / DOT 5.1 specified (PDF p. 170); Honda CB500F owner''s manual — brake fluid every 2 years (PDF p. 49), Honda DOT 4 or equivalent, and it can damage plastic and painted surfaces (PDF p. 57); Honda PCX service manual — fresh DOT 3 or DOT 4 from a sealed container, and do not mix types (PDF p. 363); Piaggio Beverly 125 service manual — the fluid is hygroscopic (PDF p. 48) and is changed every 20,000 km or every two years (PDF p. 49); Yamaha Zuma 125 2009 service manual — water "will significantly lower the boiling point of the brake fluid and could cause vapor lock" (PDF p. 89).',
             'Read the fluid type off the reservoir cap or the machine''s manual and use only that — the KTM EXC specifies DOT 4 / DOT 5.1 and forbids silicone DOT 5 (PDF pp. 102, 170); the Honda CB500F Honda DOT 4 or equivalent (PDF p. 57). Use fresh fluid from a sealed container and never mix types (Honda PCX, PDF p. 363). Change it on the maker''s interval whatever it looks like: the fluid absorbs moisture from the air (Piaggio Beverly, PDF p. 48), and water lowers its boiling point and can cause vapor lock (Yamaha Zuma 125, PDF p. 89) — every 2 years on the Honda CB500F (PDF p. 49), every 20,000 km or two years on the Beverly (PDF p. 49). Cover painted and plastic parts before opening a reservoir, and wipe up any spill at once (CB500F, PDF p. 57; KTM, PDF p. 102).',
             ...
             'Fluid past its interval is changed and the system bled; a wrong or silicone fluid in a system not designed for it means flushing and new seals, because the KTM manual says the seals and lines are not designed for DOT 5 (PDF p. 102).',
             1, '["brake fluid","clear hose","catch bottle"]', 20),

            ((SELECT id FROM workflow_templates WHERE slug='brake_service_v1'), 6,
             'Bleeding',
             'Cited: Honda PCX service manual — "Once the hydraulic system has been opened, or if the brake feels spongy, the system must be bled" (PDF p. 363); the sequence: squeeze the lever all the way, open the bleed valve 1/2 of a turn, close it, release the lever slowly, repeat; bleed valve 5.4 N·m (PDF p. 367); Yamaha Zuma 125 2009 service manual — "If bleeding is difficult, it may be necessary to let the brake fluid settle for a few hours" (PDF p. 91); bleed screw 6 Nm (PDF p. 92).',
             'Bleed whenever the circuit has been opened or the lever feels spongy (Honda PCX, PDF p. 363). Keep the reservoir topped up throughout: the Piaggio Beverly manual tops it up constantly to prevent air being drawn into the system (PDF p. 199). With a clear hose from the bleed valve into a catch bottle: squeeze the lever all the way, loosen the bleed valve half a turn, wait, close it, release the lever slowly, and repeat until the fluid runs clear and free of bubbles (PCX, PDF p. 367). Tighten the bleed valve to the machine''s own torque — 5.4 N·m on the Honda PCX (PDF p. 367), 6 Nm on the Yamaha Zuma 125 (PDF p. 92). If the bubbles will not stop, let the fluid settle for a few hours and bleed again (Zuma, PDF p. 91). Top up to the level mark and refit the cap.',
             'Clear, bubble-free fluid; bleed valves at their torque; reservoir at the level mark; a firm lever.',
             'Bubbles that will not clear, a lever that stays spongy, a weeping bleed valve.',
             'A lever that stays soft after a careful bleed has air trapped high in the system or a failing master cylinder: let the fluid settle and bleed again (Zuma, PDF p. 91), then go to the master-cylinder item.',
            ...
            ((SELECT id FROM workflow_templates WHERE slug='brake_service_v1'), 7,
             ...
             'Figures are the named machine''s own. Cited: KTM 250/300 EXC owner''s manual — front caliper screw M8 25 Nm with Loctite 243 (PDF p. 69); operate the lever "repeatedly until the brake linings are in contact with the brake disc and there is a pressure point" (PDF p. 109); BMW F800R rider''s manual — brake caliper on fork leg 30 Nm (PDF p. 106), and "New brake pads have to bed down before they can achieve their optimum friction levels" (PDF p. 67); Honda PCX service manual — caliper mounting bolt 30 N·m, ALOC bolts replaced with new ones (PDF p. 21).',
             'Torque every caliper and mounting bolt to the machine''s own figure and thread-locker: the KTM EXC''s front caliper screw is 25 Nm with Loctite 243 (PDF p. 69); the BMW F800R''s caliper on the fork leg 30 Nm (PDF p. 106); the Honda PCX''s caliper mounting bolts 30 N·m, and its ALOC bolts are replaced with new ones (PDF p. 21); the Kymco People S 250''s 29–35 N·m (service manual PDF p. 195). Before the machine moves, pump the lever and pedal until the pads meet the disc and there is a firm pressure point (KTM, PDF p. 109). Spin each wheel to check the brake releases. Tell the rider that new pads must bed in and will stop longer until they do (F800R, PDF p. 67).',
            ...
            ((SELECT id FROM workflow_templates WHERE slug='suspension_service_v1'), 1,
             ...
             'Figures are the named machine''s own. Cited: KTM 250/300 EXC owner''s manual — "first adjust the shock absorber and then the fork" (PDF p. 55); the sag gauge at the rear axle to the SAG marking (PDF p. 57); static sag 37 mm and riding sag 110 mm, the rider in full gear bouncing a few times, feet on the footrests (PDF p. 58); "no exact riding sag can be determined for the fork" (PDF p. 60); KTM 690 Enduro owner''s manual — static sag 25 mm (PDF p. 73), riding sag 70–80 mm (PDF p. 74).',
             'Before touching anything, write down every clicker, preload and ride-height setting as found, counted from the maker''s reference position. Then measure the rear sag the maker''s way: the KTM EXC manual takes a reading at the rear axle unloaded, one with the machine on its own weight (static sag), and one with the rider in full gear aboard, feet on the footrests, after bouncing a few times (riding sag), each the difference from the unloaded reading (PDF pp. 57–58). Compare with the machine''s own figures — the KTM EXC''s static sag 37 mm and riding sag 110 mm (PDF p. 58); the KTM 690 Enduro''s 25 mm and 70–80 mm (PDF pp. 73–74). Set the shock before the fork, the KTM manual''s order (PDF p. 55); the fork has no exact riding-sag figure (PDF p. 60).',
             ...
             'Riding sag outside the figure that preload cannot bring back means the wrong spring for the rider (the next item). Static sag that is right while riding sag is wrong points the same way.',
            ...
            ((SELECT id FROM workflow_templates WHERE slug='suspension_service_v1'), 2,
             ...
             'Figures are the named machine''s own. Cited: KTM 250/300 EXC owner''s manual — the standard rider weight is 75–85 kg, and "Small weight differences can be compensated by adjusting the spring preload, but in the case of large weight differences, the springs must be replaced" (PDF p. 55); its spring tables by rider weight: fork 4.2 / 4.4 / 4.6 N/mm and shock 57–63 / 60–66 / 63–69 N/mm for 65–75 / 75–85 / 85–95 kg (PDF pp. 60, 166); a fork that frequently bottoms out needs harder springs (PDF p. 60); KTM 690 Enduro owner''s manual — fork 5.2 / 5.4 / 5.6 N/mm for the same weights (PDF p. 183).',
             'Weigh the rider in full riding gear. Look up the machine''s own spring table where its maker publishes one — the KTM EXC''s fork springs are 4.2, 4.4 and 4.6 N/mm and its shock springs 57–63, 60–66 and 63–69 N/mm for riders of 65–75, 75–85 and 85–95 kg (PDF pp. 60, 166); the KTM 690 Enduro''s fork springs 5.2, 5.4 and 5.6 N/mm for the same weights (PDF p. 183). Read the rate printed on the spring fitted. If the rider sits inside the table''s standard band, preload is enough; outside it, the springs change — the KTM manual''s rule (PDF p. 55). A fork that frequently bottoms out needs harder springs (PDF p. 60). The KTM manual notes that the spring rate is shown on the outside of the spring (PDF p. 60). Where the maker publishes no table, its own spring specification is the reference, and it may offer no alternative: the Yamaha Zuma 125 service manual gives its fork spring as two rates, 7.1 N/mm (K1) and 15.4 N/mm (K2), with no optional spring available (PDF p. 34).',
             'The fitted springs match the rider''s weight in the machine''s table, or the difference is small enough for preload.',
             'Springs outside the rider''s band, a fork that bottoms, preload wound to its end to hold the sag.',
            ...
            ((SELECT id FROM workflow_templates WHERE slug='suspension_service_v1'), 3,
             ...
             'Figures are the named machine''s own. Cited: KTM 250/300 EXC owner''s manual — fork oil per leg 636 ± 10 ml, SAE 4 (PDF p. 166); KTM 690 Enduro owner''s manual — 620 ml per leg, SAE 5 (PDF p. 183); Honda PCX service manual — fork fluid capacity 122.0 ± 2.5 cm³, fluid level 75 mm, and pump the fork pipe to remove trapped air (PDF p. 335); Yamaha Zuma 125 2009 service manual — 0.104 L per leg of 10W fork oil (PDF p. 160), levels in both legs equal (PDF p. 158), stroke the outer tube while draining (PDF p. 155).',
             'Drain each leg completely, stroking the tube several times while it drains (Zuma 125, PDF p. 155). Refill with the machine''s own oil grade and quantity — 636 ± 10 ml of SAE 4 per leg on the KTM EXC (PDF p. 166); 620 ml of SAE 5 on the KTM 690 Enduro (PDF p. 183); 122.0 ± 2.5 cm³ on the Honda PCX (PDF p. 335); 0.104 L of 10W on the Yamaha Zuma 125 (PDF p. 160). Pump the leg slowly to purge the air, then set the level where the manual gives one — the Honda PCX''s is 75 mm (PDF p. 335) — and make both legs equal (Zuma, PDF p. 158).',
             ...
             'Unequal oil between the legs makes the fork work unevenly; oil that came out dark, milky or full of metal is evidence for the seal item and for wear inside the leg.',
             1, '["fork oil","measuring cylinder","fork oil level tool"]', 45),

            ((SELECT id FROM workflow_templates WHERE slug='suspension_service_v1'), 4,
             'Fork seals, dust wipers and springs',
             'Figures are the named machine''s own. Cited: Yamaha Zuma 125 2009 service manual — "Never reuse the oil seal" (PDF p. 156); lubricate the new seal lips, and fit it numbered side up (PDF p. 159); spring free length 252.1 mm, limit 247 mm (PDF p. 157); Honda PCX service manual — fork fluid on the new oil-seal and dust-seal lips, and the stopper ring in its groove (PDF p. 334); KTM 250/300 EXC owner''s manual — dirt behind the dust boots, if not removed, makes the oil seals leak (PDF p. 67); Honda CHF50 service manual — fork spring free length service limit 125.9 mm (PDF p. 227).',
             'Fit new oil seals whenever they come out — the Zuma 125 manual never reuses them (PDF p. 156) — with new dust seals. Lubricate the new lips as the manual says (lithium soap base grease on the Zuma 125, PDF p. 159; fork fluid on the Honda PCX, PDF p. 334), drive the seal in square with the numbered side up (Zuma, PDF p. 159), and seat the stopper ring in its groove (PCX, PDF p. 334). While the leg is apart, inspect the inner tube for pitting and scratches where the seal runs, and measure the spring free length against the machine''s limit — the Zuma 125''s 252.1 mm standard and 247 mm limit (PDF p. 157); the Honda CHF50''s 125.9 mm limit (PDF p. 227). On every service, clean behind the dust boots: the KTM EXC manual says dirt left there makes the seals leak (PDF p. 67).',
             ...
             'A reused seal, a nicked or pitted tube in the seal zone, a spring under its free-length limit.',
             'A new seal on a pitted tube leaks again: the tube is the repair. A spring under its free-length limit is replaced.',
            ...
            ((SELECT id FROM workflow_templates WHERE slug='suspension_service_v1'), 5,
             'Fork air bleed',
             'Only for forks with bleeder screws. Cited: KTM 250/300 EXC owner''s manual — "If the fork feels unusually hard after extended periods of operation, the fork legs need to be bled" (PDF p. 60); the bleeder screws positioned toward the front (PDF p. 69); KTM 690 Enduro owner''s manual — bleeding the fork legs (PDF p. 75).',
             'With the machine as the maker''s procedure sets it (the KTM 690 Enduro manual leans it on the side stand, PDF p. 75) and the fork unloaded, open each fork leg''s bleeder screw briefly to release trapped air, then close it. The KTM EXC manual positions the fork legs with the bleeder screws toward the front (PDF p. 69).',
             ...
             'A fork that needs bleeding often is pumping air past a seal; plan the seal item.',
             0, '[]', 5),

            ((SELECT id FROM workflow_templates WHERE slug='suspension_service_v1'), 6,
             'Rear shock — service or replace',
             'The makers disagree, and the machine''s own maker decides. Cited: KTM 250/300 EXC owner''s manual — "The shock absorber is filled with highly compressed nitrogen" (PDF p. 55), gas pressure 10 bar and shock fluid SAE 2.5 (PDF p. 167); Honda XR650L owner''s manual — the damper unit "contains high pressure nitrogen gas. Do not attempt to disassemble, service, or improperly dispose of the damper" (PDF p. 85); Yamaha Zuma 125 2009 service manual — rear shock oil leaks: "Replace the rear shock absorber assembly" (PDF p. 175); Honda PCX service manual — compress the shock several times and check the whole assembly for leaks, damage and loose fasteners (PDF p. 95).',
             'Compress the shock several times and check the whole assembly for oil on the shaft or body, damage and loose fasteners (Honda PCX, PDF p. 95). Then follow the machine''s own maker: KTM services its shocks — a nitrogen-charged unit at 10 bar with SAE 2.5 shock fluid (PDF pp. 55, 167), which is workshop work with the right equipment; Honda''s XR650L manual forbids opening its damper at all, because it holds high-pressure nitrogen, and sends the owner to the dealer (PDF p. 85); Yamaha''s Zuma 125 service manual replaces a leaking rear shock as an assembly (PDF p. 175). Never open a gas-charged shock without the maker''s procedure and the equipment to depressurise and recharge it.',
             ...
             'Oil on the shaft or body, a knock or dead spot in the stroke, a sealed damper opened.',
             'A leaking sealed shock is a replacement, not a rebuild (Zuma 125, PDF p. 175; XR650L, PDF p. 85). A serviceable one goes to a shop with nitrogen charging, filled to the maker''s gas pressure and fluid.',
             1, '[]', 30),

            ((SELECT id FROM workflow_templates WHERE slug='suspension_service_v1'), 7,
             'Damping and preload back to base',
             'Figures are the named machine''s own. Cited: KTM 250/300 EXC owner''s manual — shock standard low-speed compression 15 clicks, high-speed compression 2 turns (PDF p. 56), rebound 15 clicks (PDF p. 57), spring preload 9 mm (PDF p. 59); KTM 690 Enduro owner''s manual — "Do not change the adjustments at random or by more than ± 40%" (PDF p. 64); Honda CB500F owner''s manual — rear preload adjuster 9 positions, standard 4, and "Attempting to adjust directly from 1 to 9 or 9 to 1 may damage the shock absorber" (PDF p. 92).',
             'Return every adjuster to the machine''s standard, counted the maker''s way, before any rider-specific change — the KTM EXC shock''s standard is 15 clicks low-speed compression, 2 turns high-speed compression (PDF p. 56), 15 clicks rebound (PDF p. 57) and 9 mm spring preload (PDF p. 59); the Honda CB500F''s rear preload is position 4 of 9, reached step by step, never directly from 1 to 9 or back (PDF p. 92). Make changes from the standard in small steps: the KTM 690 Enduro manual says never at random or by more than ± 40 % (PDF p. 64). Record the final settings on the job.',
             'Every adjuster at the machine''s standard or a recorded change from it; nothing forced past its stop.',
             'Settings unknown, an adjuster forced past its limit, a jump across the adjuster''s range.',
             'If the machine only feels right far from its standard settings, the spring or the internals are wrong — go back to the spring-rate and shock items rather than winding the adjusters further.',
             1, '["screwdriver","pin spanner"]', 10),

            -- ---------------------------------------------- drivetrain_service_v1
            ((SELECT id FROM workflow_templates WHERE slug='drivetrain_service_v1'), 1,
             'Chain drive — slack',
             'Chain-drive machines. Figures are the named machine''s own. Cited: KTM 250/300 EXC owner''s manual — chain tension 55–58 mm, repeated at different chain positions because wear is not even (PDF p. 90); too tight wears the chain, sprockets, transmission and rear wheel bearings faster, too loose and "the chain may fall off" (PDF p. 89); Honda CB500F owner''s manual — slack 35–45 mm midway between the sprockets, never ridden over 60 mm, and uneven slack means kinked, binding links (PDF p. 80); BMW F800R rider''s manual — chain deflection 30–40 mm, measured at the position with the least sag (PDF p. 101).',
             'Put the transmission in neutral and measure the slack the machine''s maker''s way, at several points round the chain — the KTM manual repeats the measurement at different positions because chain wear is not even (PDF p. 90), and the BMW F800R measures at the tightest point, where the chain sags least (PDF p. 101). Compare with the machine''s own figure: 55–58 mm on the KTM EXC (PDF p. 90), 35–45 mm on the Honda CB500F with 60 mm as the do-not-ride limit (PDF p. 80), 30–40 mm on the BMW F800R (PDF p. 101).',
             'Slack inside the machine''s range and the same at every point measured.',
             'Slack out of range, or different from point to point round the chain.',
             'Slack that varies round the chain means kinked or binding links (Honda CB500F, PDF p. 80) or uneven wear: go to the wear item. Too tight is as harmful as too loose — the KTM manual lists faster wear of the chain, sprockets, transmission and rear wheel bearings (PDF p. 89).',
             0, '["ruler"]', 5),

            ((SELECT id FROM workflow_templates WHERE slug='drivetrain_service_v1'), 2,
             'Chain drive — wear, sprockets and guides',
             'Chain-drive machines. Cited: KTM 250/300 EXC owner''s manual — pull the upper run with 10–15 kg and measure 18 chain rollers of the lower run: maximum 272 mm, beyond it "Change the drivetrain kit" (PDF p. 92); chain sliding guard and sliding piece changed when the lower edge of the chain pins is in line with or below them (PDF pp. 92–93); chain guide changed when its light part is worn (PDF p. 93); Honda CB500F owner''s manual — the chain wear label''s red zone after adjustment means the chain must be replaced (PDF p. 83); "Use of a new chain with worn sprockets will cause rapid chain wear" (PDF p. 58); BMW F800R rider''s manual — pull the chain back at the rearmost point of the rear sprocket (PDF p. 102).',
             'Measure the wear the maker''s way: the KTM EXC manual loads the upper run with 10–15 kg and measures across 18 rollers of the lower run, 272 mm at most (PDF p. 92); the Honda CB500F reads a wear label on the adjuster, where the red zone after correct adjustment means replace (PDF p. 83); the BMW F800R pulls the chain back at the rearmost point of the rear sprocket — the tips of the teeth still between the links pass, a chain that lifts clear over the teeth needs a specialist (PDF p. 102). Inspect both sprockets for worn or damaged teeth (Honda CB500F, PDF p. 58). Check the chain sliding guard, sliding piece and chain guide against the KTM manual''s criteria: the chain pins'' lower edge in line with or below the slider, or the guide''s light part worn, means change it (PDF pp. 92–93).',
            ...
            ((SELECT id FROM workflow_templates WHERE slug='drivetrain_service_v1'), 3,
             ...
             'Chain-drive machines. Cited: KTM 250/300 EXC owner''s manual — rinse off loose dirt with a soft jet of water, remove old grease with chain cleaner, and after drying apply chain spray (PDF p. 89); Honda CB500F owner''s manual — for O-ring chains, "Do not use a steam cleaner, a high pressure cleaner, a wire brush, volatile solvent such as gasoline" (PDF p. 59); BMW F800R rider''s manual — "Lubricate the drive chain every 1000 km at the latest", more often in wet, dusty or dirty conditions (PDF p. 100).',
             'Clean the chain gently: the KTM manual rinses loose dirt off with a soft jet of water and removes old grease with chain cleaner (PDF p. 89). On an O-ring or sealed chain, use only cleaners and lubricants made for it — the Honda CB500F manual forbids steam cleaners, high-pressure washers, wire brushes and volatile solvents such as gasoline, which damage the rubber seals (PDF p. 59). Dry it, lubricate it, and wipe off the excess, keeping lubricant off the tire and the brake. Lubricate on the maker''s interval — every 1000 km at the latest on the BMW F800R, more often in the wet or dirt (PDF p. 100).',
            ...
            ((SELECT id FROM workflow_templates WHERE slug='drivetrain_service_v1'), 4,
             ...
             'Chain-drive machines. Figures are the named machine''s own. Cited: KTM 250/300 EXC owner''s manual — adjuster markings level on both sides against the reference marks, "The rear wheel is then correctly aligned"; rear axle nut 80 Nm (PDF p. 91); rear sprocket nut 35 Nm and engine sprocket screw 60 Nm, both with Loctite 2701 (PDF pp. 168, 163); Honda CB500F owner''s manual — rear axle nut 88 N·m, adjusting lock nuts 21 N·m (PDF p. 82); chain DID520V0, 112 links, 15T/41T sprockets (PDF p. 134); BMW F800R rider''s manual — scale readings equal on left and right (PDF p. 101); chain tensioning-screw locknut 19 Nm, rear axle 100 Nm (PDF p. 102).',
             'Loosen the axle and turn both adjusters by equal amounts until the slack is right, then check the alignment: the adjuster marks must read the same on both sides (KTM, PDF p. 91; BMW F800R, PDF p. 101). Tighten to the machine''s own torques — the KTM EXC''s rear axle nut 80 Nm (PDF p. 91); the Honda CB500F''s axle nut 88 N·m and adjuster lock nuts 21 N·m (PDF p. 82); the BMW F800R''s tensioner locknut 19 Nm and rear axle 100 Nm (PDF p. 102) — and re-check the slack after tightening. When replacing, fit the chain and sprockets as a set to the machine''s own specification (for example the Honda CB500F''s DID520V0, 112 links, 15T/41T, PDF p. 134), torque the sprocket fasteners with the specified thread-locker (the KTM EXC''s rear sprocket nuts 35 Nm and engine sprocket screw 60 Nm, Loctite 2701, PDF pp. 168, 163), and on a chain with a joint link fit it the way the chain maker specifies.',
            ...
            ((SELECT id FROM workflow_templates WHERE slug='drivetrain_service_v1'), 5,
             ...
             'Belt-drive machines. Figures are the named machine''s own. Cited: Yamaha XVS950 owner''s manual — note the belt''s position against the marks at the check hole, then again with 45 N (4.5 kgf, 10 lbf) applied with a belt tension gauge (PDF p. 65); the difference is the slack, 6.0–8.0 mm, and a Yamaha dealer adjusts it if it is out (PDF p. 66); check the belt''s condition and tension every 2500 mi (4000 km) (PDF p. 48); Yamaha XVS1300 owner''s manual — slack 5.0–7.0 mm, the check-hole marks 5.0 mm apart (PDF p. 64); "Never apply oil or wax to the drive belt" (PDF p. 82). No document in the research library sets a belt alignment figure, so none is given here.',
             'On the machine as the manual sets it (the XVS1300 on its sidestand, PDF p. 64), note where the belt sits against the marks at the check hole, then press it with the specified force on a belt tension gauge and note it again: the difference is the slack. Compare with the machine''s own figure — 6.0–8.0 mm under 45 N on the Yamaha XVS950 (PDF pp. 65–66), 5.0–7.0 mm on the XVS1300, whose marks are 5.0 mm apart (PDF p. 64). Inspect the belt''s whole length for cracks, damaged or missing teeth and debris in the pulleys, on the maker''s interval — every 2500 mi (4000 km) on the XVS950 (PDF p. 48). Never put oil or wax on the belt (XVS1300, PDF p. 82). No document in the research library sets a belt alignment figure: alignment and adjustment follow the machine''s own service manual, and on these Yamahas the owner''s manual sends adjustment to the dealer (XVS950, PDF p. 66).',
             'Slack inside the machine''s figure, belt free of cracks and damaged teeth, pulleys clean, nothing applied to the belt.',
             'Slack out of range, cracks, damaged or missing teeth, stones or debris in the pulley, oil or wax on the belt.',
             'A belt with damaged teeth or cracks is replaced, not dressed. Slack out of range is adjusted to the machine''s service procedure, which also sets the alignment — no figure for it is given here because no document in the library sets one.',
            ...
            ((SELECT id FROM workflow_templates WHERE slug='drivetrain_service_v1'), 6,
             ...
             'Shaft-drive machines. Figures are the named machine''s own. Cited: BMW R 1100 S Service and Technical Booklet — "Change the oil in the rear wheel drive while at regular operating temperature" (PDF p. 6), every 40,000 km (24,000 miles) or at the latest every 2 years (PDF p. 8); brand-name hypoid gear oil, API class GL 5, final drive approx. 0.25 l to the bottom edge of the filler screw, SAE 90 above 5 °C and SAE 80 below (PDF p. 87); BMW R 850 R / R 1150 R Maintenance Instructions — final drive approx. 0.25 l (PDF p. 67); BMW K 1200 RS Maintenance Instructions — final drive 0.25 l (PDF p. 70).',
             'Ride the machine to operating temperature first — the R 1100 S booklet changes the rear-wheel drive oil warm (PDF p. 6). Drain it, inspect the drain plug and the oil for metal particles, fit a new sealing washer, and refill with the machine''s own oil and quantity: on the BMW R 1100 S, brand-name hypoid gear oil to API class GL 5, approximately 0.25 l to the bottom edge of the filler screw, SAE 90 above 5 °C and SAE 80 below (PDF p. 87); on the R 850 R / R 1150 R and the K 1200 RS, 0.25 l as well (R 850 R / R 1150 R, PDF p. 67; K 1200 RS, PDF p. 70). Change it on the maker''s interval — every 40,000 km or at the latest every 2 years on the R 1100 S (PDF p. 8). Check the final-drive housing and its seals for leaks.',
             'Oil changed warm to the machine''s grade and level, drain plug clean, housing and seals dry.',
             'Metal particles on the plug or in the oil, oil past the interval, a leaking seal or housing.',
             'Metal on the plug or in the oil is final-drive wear inside the housing, and oil at a seal is a seal replacement before the bearing it protects is damaged; both belong to the machine''s service manual.',
