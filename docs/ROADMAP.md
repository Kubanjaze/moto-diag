...
| 223 | KTM enduro / adventure (EXC/690 **Enduro R**/450) | 🔲 | Off-road single-cylinder race bikes, hard enduro, 450/500 EXC, 690 Enduro R. **Scope confirmed by Phase 222**: this row owns the 690 **Enduro R**, not the 690 **Duke**, which is a road naked and went to row 222. They share the LC4 engine family, so engine-side content will overlap — 222 wrote only the cross-reference discipline (cross-reference the engine, not the bike) and left LC4 failure content here. |
