...
| 224 | KTM LC8 V-twin common issues | 🔲 | Cam chain tensioner, electric start issues, valve clearance intervals. **Scope question raised by Phase 222 — decide before writing**: this row says **LC8 V-twin**, but the 790/890 Duke use the **LC8c parallel twin**, a different architecture sharing a family name. As written the row does not cover the Duke twins' engine, leaving it unowned. Phase 222 avoided all three reserved topics on the LC8c so nothing is written twice whichever way this is scoped — either widen this row to the whole LC8 family, or give the LC8c its own row. |
