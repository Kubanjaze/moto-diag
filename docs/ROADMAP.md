...
| 219 | Ducati desmodromic valve service | 🔲 | Desmo 10K-18K mile service intervals, shim-over-bucket opener/closer, cost-intensive. **Scope note from the Phase 218 audit: this does NOT cover the Multistrada V4** — its Granturismo engine uses conventional spring valve return, not desmodromic, with a far longer interval. Desmo scope is the Desmodue, Desmoquattro, Testastretta, Superquadro and Desmosedici Stradale engines. |
