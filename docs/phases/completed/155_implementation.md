...
- `advanced/data/recalls.json` (30 **illustrative sample** campaigns — **corrected 2026-09-17, F86**: these were described here as "real NHTSA campaigns" and they are not. Every `nhtsa_id` sits on a synthetic {19,20,21,22}V x {012,123,…,901} x {000,500} grid, as this project's own audit established in `TRACK_K_AUDIT_VERIFIER_NOTES.md:508`. Nothing in the product seeds them, and nothing should until real data replaces them — roadmap row 281.): HD 21V123000 Touring brake, 22V456000 Softail clutch, 19V012000 stator; Honda 22V234000 CBR1000RR shift arm, 20V456000 Gold Wing airbag; Yamaha 22V567000 MT-09 brake; Kawasaki 22V789000 Ninja 400 fuel hose; Suzuki/KTM/Ducati/BMW/Triumph ~3 each.
...
Phase 155 extends Phase 118's empty `recalls` substrate into a working NHTSA lookup wired to 30 **sample** campaigns (**corrected 2026-09-17, F86** — they were called "real federal campaigns"; the ids are fabricated fixture data), adds the `recall_resolutions` junction for idempotent mark-resolved, and wires critical open recalls to severity-escalate Phase 148 predictions to "critical" within the issue's year envelope. First PPI-ready recall flow now mechanic-CLI-reachable.
