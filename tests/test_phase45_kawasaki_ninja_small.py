"""Phase 45 — Kawasaki Ninja 250/300/400 knowledge base tests."""
...
def db_path(tmp_path):
    ...
    init_db(path)
    f = SEED_DATA_DIR / "knowledge" / "known_issues_kawasaki_ninja_small.json"
    if f.exists():
        load_known_issues_file(f, path)
    return path


class TestKawasakiNinjaSmallData:
