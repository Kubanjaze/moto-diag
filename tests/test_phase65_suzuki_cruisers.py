"""Phase 65 — Suzuki cruisers Intruder/Boulevard knowledge base tests."""
...
def db_path(tmp_path):
    ...
    init_db(path)
    f = SEED_DATA_DIR / "knowledge" / "known_issues_suzuki_cruisers.json"
    if f.exists():
        load_known_issues_file(f, path)
    return path


class TestSuzukiCruiserData:
