...
#: move at all.
UNCHANGED = {"Honda": 27, "Kawasaki": 39, "Suzuki": 29, "Yamaha": 23}
...
class TestTheVocabularyIsKeyedByMarque:
    ...
    def test_the_already_complete_marques_do_not_move(self, corpus, marque, count):
        ...
        raw-key and marque-key are the same thing for them. If these move,
        the derivation changed something it had no business changing."""
